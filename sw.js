const CACHE='difor-v27-0-product-intelligence';
const CORE=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon.svg','./DIFOR_HOJA_MAESTRA_V26_0.xlsx'];
